...
export default ({ activity, children }: Props) => {
    ...
    return (
        <div className={'grid grid-cols-10 py-4 last:rounded-b group mb-2 bg-neutral-700'} css='border-radius:15px;'>
            <div className={'hidden sm:flex sm:col-span-1 items-center justify-center select-none'}>
                <div className={'flex items-center w-10 h-10 rounded-full bg-neutral-600 overflow-hidden'}>
            ...
            <div className={'col-span-10 sm:col-span-9 flex'}>
                <div className={'flex-1 px-4 sm:px-0'}>
                    <div className={'flex items-center text-neutral-50'}>
                        ...
                        <div className={classNames(style.icons, 'group-hover:text-neutral-300')}>
                            {activity.isApi && (
